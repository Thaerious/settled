...
func _ready() -> void:
	...
	if self.vic_points_view:
		self.vic_points_view.text = str(self.victory_points)
	if self.resources_view:
		self.resources_view.text = str(self.resources)
	if self.action_cards_view:
		self.action_cards_view.text = str(self.action_cards)
	if self.roads_view:
		self.roads_view.text = str(self.roads)
	if self.soldiers_view:
		self.soldiers_view.text = str(self.soldiers)
